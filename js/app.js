...
// From Locations Data
var inputFromList = [
	{ fromLocation : "Haridwar"},
	{ fromLocation : "Jawalapur"},
	{ fromLocation : "Bhadrabad"},
];
...
var buses = [
	{ fromLocation : "SBS Travels"},
	{ fromLocation : "Chaudhary Travels"},
	{ fromLocation : "SKS Bus Service"},
];
...
for (var i = 0; i < buses.length; i++) {
	optionFrom = $("<option></option>");
	optionFrom.attr("value", buses[i].fromLocation);
	inputFromDatalist.append(optionFrom);
}
...
// To Locations Data
var inputToList = [
	{ toLocation : "Jawalapur"},
	{ toLocation : "Bhadrabad"},
	{ toLocation : "Roorkee"}
];
